window.onload = function() {
  ...
  var writingPromptGrammar = {
    "location": [
      ...
      "a dank, wet port town covered in mud and death",
      "a spread out forest town, fighting against an evil cult",
    ],    
    "creature": ["ghastly apparition", "tentacled monstrosity", "nameless horror", "unspeakable creature", "eldritch abomination"],
    "event": ["a mysterious disappearance", "a series of unexplainable events", "birds fell from the sky", "an ancient prophecy coming to pass", "the awakening of something ancient", "the blood of the farm animals boils"],
    "npcDisposition": ["friendly", "neutral", "suspicious", "hostile", "insane", "drunk", "shellshocked", "pleasant", "unsettled"],
    ...
    "flaw": ['obsession', 'paranoia', 'madness', 'greed', 'fear', 'distrust'],
    "firstName": [
      "Abigail",
      "Algernon",
      "Asenath",
